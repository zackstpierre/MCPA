...
neff_vector = linspace(3.305,n2,10);
neff_plot = zeros(length(neff_vector));


for i = 1:length(neff_vector)


    [x,y,xc,yc,nx,ny,eps,edges] = waveguidemesh([n1,neff_vector(i),n3],[h1,h2,h3], ...
                                                rh,rw,side,dx,dy); 
